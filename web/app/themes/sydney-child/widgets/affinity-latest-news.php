...
class Affinity_Latest_News extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sydney_latest_news_widget', 'description' => __( 'Show the latest news from your blog.', 'sydney') );
        parent::__construct(false, $name = __('AFFINITY - Sydney FP: Latest News', 'sydney'), $widget_ops);
...
?>
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
			<div class="blog-post-container container col-md-4 col-sm-6 col-xs-12">
				<div class="blog-post ">
